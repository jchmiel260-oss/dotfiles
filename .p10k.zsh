# Generated by Powerlevel10k configuration wizard on 2026-01-31 at 17:42 CET.
...
# right frame, sparse, many icons, concise, transient_prompt, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    os_icon                 # os identifier (later +user@host)
  ...
  typeset -g POWERLEVEL9K_OS_ICON_SUFFIX=' %B%F{6}%n%b%F{247}@%B%F{3}%m%b' # os_icon username@hostname
